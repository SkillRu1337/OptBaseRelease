<%@ Page Title="Приемка материалов" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Acceptance.aspx.cs" Inherits="OptBaseNew.Acceptance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form id="form1" runat="server" visible="False">
        ...
        <div id="addMaterialForm">
            <h2>Приемка материалов</h2>
            <table class="ship-material-table accept-material-table">
                <tr>
                    <td>Материал:</td>
                ...
                <tr>
                    <td>Количество:</td>
                    <td><asp:TextBox ID="txtAcceptCount" runat="server"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>Поставщик:</td>
                    <td><asp:TextBox ID="txtAcceptProvider" runat="server"></asp:TextBox></td>
                </tr>
                <tr>
                    <td colspan="2" class="material-submit">
                        <button type="button" id="Button_AcceptMaterial">Принять материалы</button>
                    </td>
                </tr>
